...
namespace Scenes.Scripts.Fsm.State.MenuState
{
    ...
    {
        private readonly StateBase _metaState;
        ...
        public MetaFlowBuilder(StateBase metaState, MenuScreen menuScreen, ShopScreen shopScreen, BattlePassScreen battlePassScreen)
        {
        ...
        {
            var menuState = new MenuState(_menuScreen, OnLevelStartClicked);
